...
<!--				<div style="font-size:1rem; font-weight:normal;"><a id="modify" href="#">改动-></a></div>-->
				<div style="font-size:1rem; font-weight:normal;">点赞关注阿套带你摸鱼</div>
				<div style="font-size:1rem; font-weight:normal;">给大家摸了公司服务器给大家玩</div>
				<div style="font-size:1rem; font-weight:normal;">偷偷玩，评论区见</div>
            </div>
        ...
        <div id="main">
            ...
            <div class="btn-area">
                <button id="skip-slow" class="mainbtn">自动修仙</button>
                <button id="skip-fast" class="mainbtn">自动修仙2x</button>
...
<!--                <button id="domToImage" class="mainbtn">人生回放</button>-->
        ...
        <div id="main">
            ...
            <div>
                <div style="color: #fca133">玩累了点个外卖？公司项目，摸鱼了也为公司做点事</div>
                <div style="color: #fca133">关注欣优选，外卖隐藏红包、优惠电影票、团购更优惠，主要单单有返利，以前都白给了啊，兄弟。</div>
                <div style="color: #fca133">还可以提现。支持一下咯。不省钱你砍我。</div>
                <img src="../view/images/erweima.jpg" height="150" width="150" alt="" style="text-align: center">
            </div>
